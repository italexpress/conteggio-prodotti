...
export async function getProfitStats(admin: AdminApiContext, shop: string): Promise<ProfitStats> {
  ...
  const stats: ProfitStats = {
    today: { revenue: 0, orders: 0, netProfit: 0, margin: 0, adsSpend: 0, logisticsMargin: 0, positiveLogisticsMargin: 0, positiveLogisticsCount: 0, negativeLogisticsMargin: 0, negativeLogisticsCount: 0, freeShippingCost: 0, shippingRevenue: 0, codRevenue: 0 },
    thisMonth: { revenue: 0, orders: 0, netProfit: 0, margin: 0, adsSpend: 0, logisticsMargin: 0, positiveLogisticsMargin: 0, positiveLogisticsCount: 0, negativeLogisticsMargin: 0, negativeLogisticsCount: 0, freeShippingCost: 0, shippingRevenue: 0, codRevenue: 0 },
    thisYear: { revenue: 0, orders: 0, netProfit: 0, margin: 0, adsSpend: 0, logisticsMargin: 0, positiveLogisticsMargin: 0, positiveLogisticsCount: 0, negativeLogisticsMargin: 0, negativeLogisticsCount: 0, freeShippingCost: 0, shippingRevenue: 0, codRevenue: 0 },
    returns: {
    ...
    try {
      ...
      for (const edge of orders.edges) {
        ...
        const addToPeriod = (p: PeriodStats) => {
          ...
          if (logistics.margin > 0) {
            p.positiveLogisticsMargin += logistics.margin;
            p.positiveLogisticsCount++;
          }
          if (logistics.margin < 0) {
            p.negativeLogisticsMargin += logistics.margin;
            p.negativeLogisticsCount++;
          }
